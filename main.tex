  ...
  \section{Results}
    ...
    \begin{frame}{Computational Complexity}
      \begin{table}[]
        ...
        \end{tabular}
      \caption{Table of operation time complexity locally (without HTTP requests) and remoteley (with HTTP requests to API). Time is for the whole convolutional filter thus more than one encrypted vector is involved Time includes other operations E.G to decrypt, encryption must first occur.}
